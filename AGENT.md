# PayHub — Agent Guidelines

General, framework-level engineering conventions for this codebase. PayHub-specific
context, architecture, and critical rules live in `CLAUDE.md`.
