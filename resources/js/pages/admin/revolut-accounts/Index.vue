            ...
            <table class="w-full text-sm">
                <thead>
                    <tr class="bg-[#F7F5F2] border-b border-border">
                        ...
                        <th class="text-left px-5 py-3.5 text-[11px] font-semibold uppercase tracking-widest text-muted-foreground">Public Key</th>
                ...
                <tbody>
                    <tr
                        v-for="account in revolutAccounts"
                        :key="account.id"
