...
function testConnection() {
    ...
    router.post('/admin/square-accounts/test-connection',
        { access_token: form.access_token, environment: form.environment },
        {
            preserveState: true,
            preserveScroll: true,
            ...
            onError: (errors) => {
                ...
                testMessage.value = e.square_api ?? e.access_token ?? e.environment ?? 'Connection test failed.';
            },
        }
    );
}
        ...
        <Card>
            ...
            <CardFooter class="flex justify-between">
                <Button
                    type="button"
                    variant="outline"
                    :disabled="!form.access_token || testStatus === 'testing'"
