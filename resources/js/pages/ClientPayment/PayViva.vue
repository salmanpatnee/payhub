...
// checkoutUrl is assembled server-side (order code / URL structure stays a
...
async function submit(): Promise<void> {
    ...
    // Record consent for the audit trail before redirecting to Viva.
        ...
        <div class="form-content space-y-6">
            ...
            <div>
                ...
                <p class="text-sm text-slate-500 mt-1.5 leading-relaxed">
                    You'll be redirected to Viva to enter your card details securely.
                </p>
            </div>
